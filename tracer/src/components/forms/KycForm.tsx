  ...
  return (
    <form onSubmit={handleSubmit} className="kyc-form-layout">
      ...
      <style>{`
        ...
        .module-step { font-family: monospace; font-size: 0.75rem; color: var(--primary-color); font-weight: 700; background: #eff6ff; padding: 0.25rem 0.6rem; border-radius: 4px; }
