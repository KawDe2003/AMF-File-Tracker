    ...
    <AppLayout>
      <div className="explorer-container">
        ...
        <style>{`
          ...
          .ref-pill { display: inline-block; padding: 0.25rem 0.65rem; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 6px; color: var(--primary-color); font-family: 'JetBrains Mono', monospace; font-size: 0.75rem; font-weight: 700; }
          ...
          .fit-id-badge { font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; background: var(--slate-900); color: white; padding: 0.15rem 0.65rem; border-radius: 4px; margin-top: 0.25rem; }
